...
// Part 2
// free_and_coalesce(head, NEW) {
// ##find insertion point
// prev = NULL
// curr = head
// while (curr != NULL && &curr < &NEW) {
//   prev = curr
//   curr = curr->next
// }
// NEW->next = curr
// NEW->prev = prev
//
//  ##attempt coalescing NEW and curr
// if (NEW->next != NULL && adjacent(NEW, NEW->next) {
//   NEW->size = NEW->size + NEW->next->size
//   NEW->next = NEW->next->next
//  }
//
//  ##attempt coalescing NEW and prev
//  if (prev != NULL && adjacent(prev,NEW) {
